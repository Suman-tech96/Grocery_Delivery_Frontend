...
export default function Hero() {
  ...
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-4 py-2 md:py-6">
        <div className="relative h-[280px] sm:h-[340px] md:h-[480px] w-full overflow-hidden rounded-[1.5rem] md:rounded-[2rem] shadow-xl shadow-emerald-50 group">
