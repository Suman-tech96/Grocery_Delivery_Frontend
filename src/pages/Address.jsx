      ...
      <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-10 items-center bg-white rounded-[2rem] p-6 md:p-10 shadow-2xl border border-gray-100 animate-fade-in">
        <div className="space-y-6">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-black text-gray-900 mt-3 tracking-tighter italic leading-tight">Identify Your <br /><span className="text-emerald-500">Destination</span></h1>
          ...
          <form onSubmit={save} className="grid gap-3">
            ...
            <button className="w-full bg-gray-900 text-white font-black py-4 rounded-xl hover:bg-emerald-600 transition-all shadow-lg shadow-gray-100 text-[10px] uppercase tracking-widest italic mt-4">
                SECURE ADDRESS CORES
            </button>
          </form>
        </div>
